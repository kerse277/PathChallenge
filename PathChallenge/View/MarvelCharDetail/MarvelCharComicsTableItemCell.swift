//
//  MarvelCharComicsTableItemCell.swift
//  PathChallenge
//
...
class MarvelCharComicsTableItemCell : PCUITableViewCell<MarvelCharComicsDto> {
    var cellDelegate: MarvelCharComicsTableItemCellDelegate?
    var index: Int?
    ...
    override func bind(item: MarvelCharComicsDto) {
...
protocol MarvelCharComicsTableItemCellDelegate {
